...
> gerado por `onp-spec plano` em 2026-09-11 13:36 — NÃO edite à mão;
> mudou tasks.md ou a config? Regenere: `onp-spec plano align-milestone-7-checkout-contract --sequencial`
...
|---|---|---|---|
| T-303 | Align Gateway and E2E checkout operation shapes | `gpt-5.6-sol` | high |
...
3. gate final na branch de trabalho: `onp-spec verify align-milestone-7-checkout-contract` + `onp-spec audit --ci` — **exit 0 ou não está pronto**
