#!/usr/bin/env bash
# executar-tarefas.sh — gerado por `onp-spec plano federated-platform-architecture-refactor` em 2026-08-28 21:56
...
RUN_ID='desafio-dev-backend-senior-federated-platform-architecture-refactor-mtdhr0kv'
