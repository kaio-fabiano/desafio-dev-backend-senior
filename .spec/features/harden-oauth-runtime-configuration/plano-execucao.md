...
|---|---|---|---|
| T-269 | Harden OAuth runtime configuration and Gateway DPoP replay protection | `gpt-5.6-sol` | high |
...
Logs: `../onp-worktrees/desafio-dev-backend-senior-harden-oauth-runtime-config-harden-oauth-runtime-configuration-logs/`.
