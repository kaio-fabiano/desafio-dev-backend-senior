...
- Refs: US-004, AC-008
- Arquivos: package.json, pnpm-lock.yaml, pnpm-workspace.yaml, nx.json, tsconfig.base.json, onpspec.config.json, apps/poc-harness/package.json, test/marco-0-workspace.test.mjs
