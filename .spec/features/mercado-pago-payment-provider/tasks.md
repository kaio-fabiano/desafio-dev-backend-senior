...
## T-124 — Establish bounded contexts and truthful payment states [pendente]
...
## T-125 — Integrate Mercado Pago through the outbound port [pendente]
...
## T-126 — Receive and deduplicate signed provider notifications [pendente]
...
## T-127 — Propagate secure inputs and truthful outcomes [pendente]
