...
## T-146 — Run and repair the complete credential-free quality gate [pendente]
...
## T-147 — Automate redacted Mercado Pago test-environment verification [pendente]
...
## T-148 — Complete secret-backed SST runtime and deployment checks [pendente]
