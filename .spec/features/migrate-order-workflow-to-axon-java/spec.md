...
| Q-024 | What are the approved terminal Transaction states and the policy for inventory commit failure after payment approval? | aberta | Proposed compensation is Inventory failure -> Payment refund and Transaction compensation state; product approval is required. |
