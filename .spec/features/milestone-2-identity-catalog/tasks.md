...
## T-014 — Pin identity dependencies and reproducible configuration [concluida]
- Refs: US-015, AC-024
...
## T-015 — Validate tokens and derive the federated identity [concluida]
...
## T-016 — Link registration to WordPress consistently [concluida]
...
## T-017 — Enforce supplier-company ownership [concluida]
- Refs: US-019, AC-030
...
## T-019 — Batch federated catalog references per request [concluida]
- Refs: US-021, AC-032
...
## T-020 — Assemble the Milestone 2 gateway gate [concluida]
