...
## T-021 — Extend the schema-first commerce contract [concluida]
...
## T-022 — Adapt authenticated WooCommerce cart operations [concluida]
...
## T-023 — Add MikroORM commerce persistence and migrations [concluida]
...
## T-024 — Implement concurrent idempotent checkout and recovery [concluida]
- Refs: US-023, US-024, AC-035, AC-036, AC-037, AC-038, AC-039
...
## T-026 — Resolve cart, checkout, and workflow through federation [concluida]
...
## T-027 — Assemble the Milestone 3 acceptance gate [concluida]
