...
> gerado por `onp-spec plano` em 2026-09-05 20:44 — NÃO edite à mão;
> mudou tasks.md ou a config? Regenere: `onp-spec plano milestone-7-e2e-deployment --sequencial`

## Resumo — o que vai acontecer

- **modo SEQUENCIAL (escolha do usuário)**: 2 tarefa(s) pendente(s), UMA APÓS A OUTRA, na árvore principal (9 já concluída(s): T-046, T-047, T-048, T-049, T-050, T-051, T-052, T-145, T-146)
...
| T-208 | Restore federated WooCommerce cart continuity | `gpt-5.6-sol` | high |
