...
## T-053 — Establish the honest compliance gate [pendente]
- Refs: US-040, US-043, US-044, AC-078, AC-079, AC-085, AC-086, AC-087, AC-088
- Arquivos: docs/evidence/milestone-8/review.md, docs/evidence/milestone-8/requirements.md, test/milestone-8-compliance-contract.test.mjs, onpspec.config.json
- Modelo: gpt-5.6-luna
- Esforço: baixo
- Notes: Encode the review gaps before implementation. Source-shape assertions cannot replace runtime proofs.

## T-054 — Repair the reproducible Nx quality toolchain [pendente]
...
## T-055 — Complete Identity and Gateway federation runtime [pendente]
...
## T-056 — Complete Commerce runtime composition [pendente]
...
## T-057 — Complete payment and inventory worker runtime [pendente]
...
## T-058 — Replace the simulated E2E with the delivered system [pendente]
...
## T-059 — Retire obsolete PoC project structure [pendente]
- Refs: US-043, AC-087
...
## T-060 — Harden offline SST and delivery documentation [pendente]
- Refs: US-044, AC-088
