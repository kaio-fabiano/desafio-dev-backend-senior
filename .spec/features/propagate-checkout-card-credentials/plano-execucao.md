...
> gerado por `onp-spec plano` em 2026-09-10 18:45 — NÃO edite à mão;
...
|---|---|---|---|
| T-270 | Propagate the short-lived Card credential through choreography | `gpt-5.6-sol` | high |
...
Logs: `../onp-worktrees/desafio-dev-backend-senior-propagate-checkout-card-credentials-propagate-checkout-card-credentials-logs/`.
