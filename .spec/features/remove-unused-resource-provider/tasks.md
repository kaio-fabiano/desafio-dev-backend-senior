...
## T-177 — Remove the unused resource lifecycle abstraction [concluida]
- Refs: US-107, AC-219
- Arquivos: libs/platform/nest/src/index.ts, test/nest-provider-composition.test.mjs
- Modelo: gpt-5.6-luna
- Esforço: baixo
- Notas: Delete dead code and adjust its structural contract test; no replacement abstraction.
