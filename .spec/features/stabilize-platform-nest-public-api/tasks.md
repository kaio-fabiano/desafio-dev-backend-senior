...
## T-182 — Stabilize the platform NestJS public API [concluida]
- Refs: US-110, AC-224
- Arquivos: libs/platform/nest/src/index.ts, test/platform-nest-public-api.test.mjs
- Modelo: gpt-5.6-sol
- Esforço: alto
- Notas: Keep the barrel minimal and verify only its package entrypoint and private implementation boundaries without duplicating the export list.
