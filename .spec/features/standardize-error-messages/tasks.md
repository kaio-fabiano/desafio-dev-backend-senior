...
## T-260 — Add final executable error-message governance [em-andamento]
...
## T-261 — Standardize Gateway TypeScript errors [em-andamento]

- Refs: US-139, AC-298, AC-300, AC-301, AC-302
- Arquivos: test/error-message-gateway.test.mjs, apps/gateway/src, libs/gateway/nest/src, apps/gateway/src/presentation/gateway-runtime-messages.ts, libs/gateway/nest/src/application/gateway-error-messages.ts
- Modelo: gpt-5.6-sol
- Esforço: alto
...
## T-262 — Standardize Java Transaction errors [em-andamento]
...
## T-263 — Standardize Java Inventory errors [em-andamento]
...
## T-264 — Standardize Java Payment errors [em-andamento]
...
## T-265 — Standardize Java shared-boundary errors [em-andamento]
...
## T-266 — Standardize Identity TypeScript errors [em-andamento]

- Refs: US-139, AC-298, AC-300, AC-301
- Arquivos: test/error-message-identity.test.mjs, apps/identity-subgraph/src, libs/identity/nest/src, libs/identity/nest/src/application/errors/identity-error-messages.ts
- Modelo: gpt-5.6-sol
- Esforço: alto
...
## T-267 — Standardize Platform OAuth TypeScript errors [em-andamento]

- Refs: US-139, AC-298, AC-300, AC-301
- Arquivos: test/error-message-platform-oauth.test.mjs, libs/platform/nest/src, libs/platform/nest/src/oauth-resource/domain/errors/oauth-credential-messages.ts, libs/platform/nest/src/oauth-resource/infrastructure/errors/oauth-resource-verification-messages.ts
- Modelo: gpt-5.6-sol
- Esforço: alto
