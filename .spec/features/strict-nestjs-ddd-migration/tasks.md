...
- Arquivos: libs/identity, libs/identity/nest/src/application/commands/register-identity.command.ts, libs/identity/nest/src/application/dto/oauth-client-definition.dto.ts, libs/identity/nest/src/application/dto/oauth-client-ids.dto.ts, libs/identity/nest/src/application/dto/oauth-seed-credentials.dto.ts, libs/identity/nest/src/application/dto/registration-compensation-failure.dto.ts, libs/identity/nest/src/application/errors/oauth.error.ts, libs/identity/nest/src/application/errors/registration.error.ts, libs/identity/nest/src/application/policies/oauth-client-provisioning.policy.ts, libs/identity/nest/src/application/ports/customer-identity.port.ts, libs/identity/nest/src/application/ports/identity-account.port.ts, libs/identity/nest/src/application/ports/oauth-client-provisioning.port.ts, libs/identity/nest/src/application/ports/oauth-seed-credentials.port.ts, libs/identity/nest/src/application/use-cases/compensate-registration.use-case.ts, libs/identity/nest/src/application/use-cases/provision-oauth-clients.use-case.ts, libs/identity/nest/src/application/use-cases/register-identity.use-case.ts, libs/identity/nest/src/domain/policies/identity-registration.policy.ts, tools/architecture/strict-ddd-legacy-baseline.json
- Modelo: gpt-5.6-sol
- Esforço: alto
...
- Arquivos: libs/identity/nest/src, apps/identity-subgraph/src, libs/identity/nest/src/application/dto/identity-user-connection.dto.ts, libs/identity/nest/src/application/dto/identity-user.dto.ts, libs/identity/nest/src/application/ports/identity-user-query.port.ts, libs/identity/nest/src/application/use-cases/find-identity-users.use-case.ts, libs/identity/nest/src/application/use-cases/list-identity-users.use-case.ts, libs/identity/nest/src/infrastructure/better-auth/better-auth-identity-account.adapter.ts, libs/identity/nest/src/infrastructure/cursor/user-cursor.encoder.ts, libs/identity/nest/src/infrastructure/oauth/better-auth-oauth-client-provisioning.adapter.ts, libs/identity/nest/src/infrastructure/oauth/environment-oauth-seed-credentials.adapter.ts, libs/identity/nest/src/infrastructure/persistence/better-auth-identity-user.adapter.ts, libs/identity/nest/src/infrastructure/wordpress/wordpress-customer-identity.adapter.ts, libs/identity/nest/src/presentation/graphql/user-cursor.decoder.ts, test/identity-federation-refactor.test.mjs, test/wordpress-registration-graphql.contract.test.mjs, tools/architecture/strict-ddd-legacy-baseline.json
- Modelo: gpt-5.6-sol
- Esforço: alto
...
- Arquivos: libs/platform, libs/platform/nest/src/oauth-resource/application/dto/oauth-credential-verification.dto.ts, libs/platform/nest/src/oauth-resource/application/ports/oauth-credential-verifier.port.ts, libs/platform/nest/src/oauth-resource/application/use-cases/verify-oauth-credential.use-case.ts, libs/platform/nest/src/oauth-resource/domain/errors/oauth-credential.error.ts, libs/platform/nest/src/oauth-resource/domain/policies/required-scopes.policy.ts, libs/platform/nest/src/oauth-resource/domain/value-objects/oauth-claims.ts, libs/platform/nest/src/oauth-resource/infrastructure/http/oauth-http-request.ts, libs/platform/nest/src/oauth-resource/presentation/graphql/oauth-authentication-messages.ts, libs/platform/nest/src/oauth-resource/presentation/graphql/oauth-graphql-context.ts, libs/platform/nest/src/oauth-resource/presentation/graphql/required-scopes.metadata.ts, test/oauth-resource-server-auth.spec.test.mjs, tools/architecture/strict-ddd-legacy-baseline.json
- Modelo: gpt-5.6-sol
- Esforço: alto
...
- Arquivos: libs/gateway, apps/gateway/src, apps/gateway/src/subscriptions/gateway-sse.provider.ts, libs/gateway/nest/src/application/dto/authentication-principal.dto.ts, libs/gateway/nest/src/application/dto/commerce-session-headers.dto.ts, libs/gateway/nest/src/application/dto/federation-capabilities.dto.ts, libs/gateway/nest/src/application/dto/gateway-authentication-request.dto.ts, libs/gateway/nest/src/application/dto/gateway-context.dto.ts, libs/gateway/nest/src/application/ports/commerce-cookie.port.ts, libs/gateway/nest/src/application/ports/gateway-token-verifier.port.ts, libs/gateway/nest/src/application/ports/order-workflow-subscription.port.ts, libs/gateway/nest/src/application/use-cases/capture-federation-response.use-case.ts, libs/gateway/nest/src/application/use-cases/create-gateway-context.use-case.ts, libs/gateway/nest/src/application/use-cases/forward-gateway-subscription.use-case.ts, libs/gateway/nest/src/application/use-cases/prepare-federation-request.use-case.ts, libs/gateway/nest/src/infrastructure/auth/gateway-jwt-header.adapter.ts, libs/gateway/nest/src/infrastructure/http/commerce-cookie.adapter.ts, libs/gateway/nest/src/infrastructure/http/gateway-request.adapter.ts, libs/gateway/nest/src/infrastructure/http/gateway-request.dto.ts, libs/gateway/nest/src/infrastructure/http/set-cookie-values.adapter.ts, libs/gateway/nest/src/presentation/graphql/gateway-unauthenticated.error.ts, test/gateway-federation-refactor.test.mjs, tools/architecture/strict-ddd-legacy-baseline.json
- Modelo: gpt-5.6-sol
- Esforço: alto
...
- Refs: US-125, US-126, AC-267, AC-268
- Arquivos: infra, apps/e2e, apps/e2e/src/sandbox-environment.ts, tools, scripts, test, package.json, nx.json, tsconfig.base.json, pnpm-workspace.yaml
- Modelo: gpt-5.6-terra
- Esforço: medio
...
## T-224 — Close the repository-wide baseline and publish migration evidence [concluida]
- Refs: US-121, US-122, US-126, AC-258, AC-259, AC-260, AC-261, AC-269
- Arquivos: libs/gateway/nest/src/index.ts, tools/architecture/strict-ddd-policy.mjs, tools/architecture/strict-ddd-legacy-baseline.json, test/strict-ddd-architecture.test.mjs, docs/standards/strict-nestjs-ddd.md, docs/domain/context-map.md, docs/prds/01-arquitetura-e-dominio.md, graphify-out, .spec/features
- Modelo: gpt-5.6-sol
- Esforço: alto
